...
class registerpanelMember extends React.Component {
  ...
  savepanelMemberData(e) {
    ...
    if (!this.state.fullname) {
      ...
      axios
        .post("http://localhost:3001/api/panelmember/add", panelMember)
        .then(() => {
                        ...
                        <form className="mx-1 mx-md-4">
                          ...
                          <div>
                            ...
                            <input
                              ...
                              onChange={this.setpanelMemberPhone}
                              required
                            />
                            <div id="pn"></div>
                          </div>
                          <div>
                            ...
                            <input
                              ...
                              onChange={this.setpanelMemberEmail}
                              required
                            />
                            <div id="em"></div>
                          </div>
                          ...
                          <div>
                            ...
                            <input
                              ...
                              onChange={this.setpanelMemberPassword}
                              required
                            />
                            <div id="ps"></div>
                          </div>
                          ...
                          <div className="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                            <Link
                              to={url + this.state.email +"/"+this.state.passwords}
                            >
                              <button
                                type="button"
                                className="btn btn-primary btn-lg"
                                onClick={this.savepanelMemberData}
                              >
                                Register
                              </button>
                            </Link>
